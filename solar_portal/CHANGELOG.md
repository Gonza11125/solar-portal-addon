...
- Nabídka „7 dní Solario PRO zdarma" pro uživatele Solario Home s vlastním Home Assistantem, kteří jsou ve FREE a trial ještě nepoužili.
- Jedním kliknutím se vytvoří jednorázový propojovací kód a Solario ho rovnou bezpečně aktivuje.
- Trial odemkne plný tarif PRO na 7 dní bez platební karty a bez automatické platby.
- Po skončení trialu se placené oprávnění na serveru ukončí a Solario Local se automaticky vrátí na FREE; lokální data se nemažou.
- Jedna instalace může využít trial pouze jednou.
- Pokud uživatel nabídku zavře, může ji později znovu otevřít tlačítkem „7 dní PRO zdarma" vpravo dole.
- Fixed-term partner device tokeny se ověřují i po aktivaci proti platnosti cloudového oprávnění.

Lokální data (historie, nastavení, ruční mapování senzorů) zůstávají na disku. Nastavení, která vznikla až ve verzích 0.7.x, tato verze nečte.
